...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodyreturnandexchangepolicy.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying the Return and Exchange Policy -->
            <section class="return-body">
                <!-- Breadcrumb navigation indicating Home and Return and Exchange Policy -->
                <div class="from-tab-return">
                    <a href="index.php">Home</a><span>> Return and Exchange Policy</span>
                </div>
                <!-- Header for the Return and Exchange Policy section -->
                <div class="return-head">
                    <h1>Return and Exchange Policy</h1>
                </div>
                <!-- Paragraphs providing information about the Return and Exchange Policy -->
                <div class="return-para">
                    <p>Items purchased from our online store can be sent back for exchange at our outlet or you can contact our customer service if you wish to send the items through courier.</p><br>
                    <p>Limelight allows its customers to exchange the purchased items subject to conditions. The exchange of item will be allowed if:</p><br>
                    <ul>
                    ...
                    <br>
                    <p>Items bought on sale cannot be exchanged. If an item bought on regular price goes on sale, it will be exchanged at sale price.</p><br>
                    <p>FashionFlix has the right, at its the sole discretion, to accept or deny the request for exchange.</p><br>
                    <p>Upon the acceptance of request for exchange, the customer will be notified by our customer service.</p><br>
                    <p>This exchange policy does not apply to orders to be shipped outside Pakistan.</p><br>
                    <p id="bold">FashionFlix strictly follows 'NO refund' policy</p><br>
                    <p>The option of cashback is not available. The Exchange Policy will be applicable once the customer has placed the order and has received the parcel or payment has been processed.</p><br>
                    <p id="bold">Damage & Claims</p><br>
                    <p>The exchange of Damaged item(s) will be allowed if the item(s) received has any kind of manufacturing defect, shipment of wrong size or wrong item.</p><br>
                    <p>The complaint has to be raised within 2 working days along with paper invoice (via call, message or email) after receiving the parcel.</p><br>
                    <p>Please allow one week for the processing of damage and claims.</p><br>
                    <p>Please note, the items purchased from our retail outlet cannot be sent to us for exchange through courier. The items can be exchanged at our retail outlet.</p>
                </div>
            </section>
        </main>
        <!-- Footer section -->
