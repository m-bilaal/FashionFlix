...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodybottoms.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying breadcrumbs and a banner image for the Bottoms category -->
            <section class="bottoms-back">
                <!-- Breadcrumb navigation indicating Home, Shop, and Bottoms -->
                <div class="from-tab-bottoms">
                    <a href="index.php">Home</a><span>></span><a href="shop.php">Shop</a><span>> Bottoms</span>
                </div>
                <!-- Container for displaying a banner image related to Bottoms -->
                <div class="bottoms-image">
                    <!-- Adding image or banner content here -->
                </div>
            </section>
            <!-- Section for displaying all items related to Bottoms -->
            <section class="all-items">
            <div class="items-1">
                <?php

                    // PHP code to fetch and display specific products
                    $specificProductIDs = [45, 46, 47, 48];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [189, 190, 191, 192];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [193, 194, 195, 196];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [197, 198, 199, 200];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [201, 202, 203, 204];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [205, 206, 207, 208];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [209, 210, 211, 212];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [213, 214, 215, 216];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [217, 218, 219, 220];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [221, 222, 223, 224];
        ...
        <script src="/FashionFlix-Website/JavaScript/bottoms.js"></script>
    </body>
</html>