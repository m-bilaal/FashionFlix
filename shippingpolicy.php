...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodyshippingpolicy.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying the Shipping Policy -->
            <section class="shipping-body">
                <!-- Breadcrumb navigation indicating Home and Shipping Policy -->
                <div class="from-tab-shipping">
                    <a href="index.php">Home</a><span>> Shipping Policy</span>
                </div>
                <!-- Header for the Shipping Policy section -->
                <div class="shipping-head">
                    <h1>Shipping Policy</h1>
                </div>
                <!-- Paragraphs containing information about the Shipping Policy -->
                <div class="shipping-para">
                    <h3>Delivery within Pakistan</h3><br>
                    <p>All orders within Pakistan are routed through TCS, Leopords, Call Courier and many others courier services. All our domestic clients will be provided with a tracking ID when the order is dispatched.</p><br>
                    <p>Upon placing an order, you will receive a verification call or SMS from our Customer Service to confirm the order. If you fail to verify, your order will be automatically cancelled after 3 days (only applicable to purchases made through Cash on Delivery method). Once the order is verified, it will be dispatched within 1-2 working days and will be delivered to you within 4-5 working days.</p><br>
                    <p>We offer free delivery on orders above Rs.2500 within Pakistan.</p><br>
                    <h3>International Orders</h3><br>
                    <p>International orders are routed through DHL. All our international clients will be provided with a tracking ID when the order is dispatched.</p><br>
                    <p>International clients shall also receive a sales invoice via email and notification of shipment via email. The customer shall bear any additional charges for custom clearance or any other variation in price beyond our control.</p>
                </div>
            </section>
        </main>
        <!-- Footer section -->
