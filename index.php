...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodyhome.css">
    ...
    <body>
        <?php session_start(); ?>
        <?php include("Backend/backend-admin.php"); ?>
        <?php
        ...
        <!-- Main section -->
        <main>
            <!-- Featured section with a video background and promotional text -->
            <section class="home-back">
                <div class="home-video">
                    <!-- Video element with autoplay, muted, loop, and disablePictureInPicture attributes -->
                    <video autoplay muted loop disablePictureInPicture>
                        <source src="/FashionFlix-Website/Videos/shop-video.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="home-text">
                    <!-- Promotion text, encouraging users to sign up and shop -->
                    <div>
                        <h1>Winter Sale</h1>
                        <h2>Upto 40% off</h2><br>
                        <p>Sign up now and get 50% off on your first hassle-free shopping</p><br>
                        <a href="shop.php"><button>Shop Now</button></a>
                    </div>
                </div>
            </section>
            <!-- Services section with placeholder service icons -->
            ...
            <!-- Featured Collection section with specific product displays -->
            <section class="featured">
                <h2>Featured Collection</h2><br>
                <h4>Premium Styling Looks</h4>
                <!-- Collection-1 with product display and "Show More" button -->
                ...
                <!-- Collection-2 with product display and "Show More" button -->
                ...
                <!-- "Show More" button for the Featured Collection -->
                <div class="more-1">
                    <a href="shop.php"><button>Show More</button></a>
                </div>
            </section>
            <!-- New Arrivals section with specific product displays -->
            <section class="new-arrivals">
                <h2>New Arrivals</h2><br>
                <h4>New Modern Looks</h4>
                <!-- Collect-1 with product display and "Show More" button -->
                <div class="collect-1">
                <?php

                    // PHP code to fetch and display specific products
                    $specificProductIDs = [25, 26, 27, 28];
                ...
                <!-- Collect-2 with product display and "Show More" button -->
                <div class="collect-2">
                <?php

                    // PHP code to fetch and display specific products
                    $specificProductIDs = [29, 30, 31, 32];
                ...
                <!-- "Show More" button for the New Arrivals section -->
                <div class="more-2">
                    <a href="shop.php"><button>Show More</button></a>
                </div>
            </section>
