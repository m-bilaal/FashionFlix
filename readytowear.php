...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodyreadytowear.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying Ready to Wear items -->
            <section class="readytowear-back">
                <!-- Breadcrumb navigation indicating Home, Shop, and Ready to Wear -->
                <div class="from-tab-readytowear">
                    <a href="index.php">Home</a><span>></span><a href="shop.php">Shop</a><span>> Ready to Wear</span>
                </div>
                <!-- Placeholder for Ready to Wear images -->
                <div class="readytowear-image">
            ...
            <section class="all-items">
                ...
                <?php
                    ...
                    $specificProductIDs = [33, 34, 35, 36];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [37, 38, 39, 40];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [89, 90, 91, 92];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [93, 94, 95, 96];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [97, 98, 99, 100];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [101, 102, 103, 104];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [105, 106, 107, 108];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [109, 110, 111, 112];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [113, 114, 115, 116];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [117, 118, 119, 120];
        ...
        <script src="/FashionFlix-Website/JavaScript/readytowear.js"></script>
    </body>
</html>