...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodysearch.css">
    ...
    <body>
        ...
        <main>
            ...
            <section class="search-body">
                <!-- Breadcrumb navigation indicating Home and Search -->
                <div class="from-tab-search">
                ...
                <div class="search-results" id="searchResults">
                    <?php
                        ...
                        if (isset($_GET['keyword'])) {
                            ...
                            // Query the database for products matching the search keyword
