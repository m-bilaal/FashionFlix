...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodymodestwear.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying Modest Wear items -->
            <section class="modestwear-back">
                <!-- Breadcrumb navigation indicating Home, Shop, and Modest Wear -->
                <div class="from-tab-modestwear">
                    <a href="index.php">Home</a><span>></span><a href="shop.php">Shop</a><span>> Modest Wear</span>
                </div>  
                <!-- Placeholder for Modest Wear images -->
                <div class="modestwear-image">
            ...
            <div class="items-1">
                <?php
                    ...
                    $specificProductIDs = [49, 50, 51, 52];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [53, 54, 55, 56];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [225, 226, 227, 228];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [229, 230, 231, 232];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [233, 234, 235, 236];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [237, 238, 239, 240];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [241, 242, 243, 244];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [245, 246, 247, 248];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [249, 250, 251, 252];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [253, 254, 255, 256];
        ...
        <script src="/FashionFlix-Website/JavaScript/modestwear.js"></script>
    </body>
</html>