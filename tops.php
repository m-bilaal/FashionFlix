...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodytops.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying Tops items -->
            <section class="tops-back">
                <!-- Breadcrumb navigation indicating Home, Shop, and Tops -->
                <div class="from-tab-tops">
                    <a href="index.php">Home</a><span>></span><a href="shop.php">Shop</a><span>> Tops</span>
                </div>
                <!-- Placeholder for Tops images -->
            ...
            <section class="all-items">
                ...
                <?php
                    ...
                    $specificProductIDs = [41, 42, 43, 44];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [153, 154, 155, 156];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [157, 158, 159, 160];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [161, 162, 163, 164];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [165, 166, 167, 168];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [169, 170, 171, 172];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [173, 174, 175, 176];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [177, 178, 179, 180];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [181, 182, 183, 184];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [185, 186, 187, 188];
        ...
        <script src="/FashionFlix-Website/JavaScript/tops.js"></script>
    </body>
</html>