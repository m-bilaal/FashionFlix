...
<html lang="en">
    <head>
        ...
        <!-- Page title -->
        <title>Information and Shipping</title>
        <!-- Favicon -->
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodycheckout-1.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for information and shipping details in the checkout process -->
            <section class="checkout-body">
                <!-- Breadcrumb navigation indicating Home, Cart, and Information & Shipping -->
                <div class="from-tab-checkout">
                    <a href="index.php">Home</a><span>>&nbsp;</span><a href="cart.php">Cart</a><span>> Information and Shipping</span>
                </div>        
                <!-- Header for the information and shipping section -->
                <div class="checkout-head">
                    <h1>Information and Shipping</h1>
                </div>      
                <!-- Form to collect user's information and shipping details -->
                <div class="checkout-form">
                    <form action="Backend/backend-checkout-1.php" method="post">
                        <div>
                            <!-- Input fields for name and email -->
                            <input id="checkout-name" type="text" name="name" required>
                            <label id="label-name" for="name">Name</label>
                            <input id="checkout-email" type="text" name="email" required>
                            <label id="label-email" for="email">Email</label><br><br>
                        </div>
                        <div>
                            <!-- Input field for phone number -->
                            <input id="checkout-phone" type="number" name="phone" required>
                            <label id="label-phone" for="phone">Phone</label><br><br>
                        </div>
                        <div>
                            <!-- Dropdown for selecting the country -->
                            <select id="checkout-country" type="text" name="country" required>
                        ...
                        <div>
                            <input id="checkout-state" type="text" name="state" required>
                            <label id="label-state" for="state">State</label><br><br>
                            </div>
                            <div>
                            <input id="checkout-city" type="text" name="city" required>
                            <label id="label-city" for="city">City</label><br><br>
                            </div>
                            <div>
                            <input id="checkout-address" type="text" name="address" required>
                            <label id="label-address" for="address">Address</label><br><br>
                            </div>
                            <div>
                            <input id="checkout-code" type="number" name="code" required>
                            <label id="label-code" for="code">Postal Code</label><br><br>
                            </div>
                        </div>
                        <!-- Submit button to proceed to the shipping stage -->
                        <button type="submit">Continue to Shipping</button><br><br><br>
                    </form>
                </div>
            </section>    
        </main>
