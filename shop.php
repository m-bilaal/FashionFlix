...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodyshop.css">
    ...
    <script>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying Shop items -->
            <section class="shop-back">
                <!-- Breadcrumb navigation indicating Home and Shop -->
                <div class="from-tab-shop">
        ...
        <script src="/FashionFlix-Website/JavaScript/shop.js"></script>
    </body>
</html>