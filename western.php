...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/FashionFlix-Website/CSS/bodywestern.css">
    ...
    <body>
        ...
        <!-- Main section -->
        <main>
            <!-- Section for displaying Western items -->
            <section class="western-back">
                <!-- Breadcrumb navigation indicating Home, Shop, and Western -->
                <div class="from-tab-western">
                    <a href="index.php">Home</a><span>></span><a href="shop.php">Shop</a><span>> Western</span>
                </div>
                <!-- Placeholder for Western images -->
                <div class="western-image">
            ...
            <div class="items-1">
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [121, 122, 123, 124];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [125, 126, 127, 128];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [129, 130, 131, 132];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [133, 134, 135, 136];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [137, 138, 139, 140];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [141, 142, 143, 144];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [145, 146, 147, 148];
                ...
                <?php
                    ...
                    // PHP code to fetch and display specific products
                    $specificProductIDs = [149, 150, 151, 152];
        ...
        <script src="/FashionFlix-Website/JavaScript/western.js"></script>
    </body>
</html>